...
async function getAllGrades() {
  ...
  //  Set() e uma estrutura de conjuntos, de elementos que nao podem se repetir
  //  o js faz isso automaticamento quando inserimos elementos nesse conjunto
  let allStudents = new Set();
  grades.forEach((grade) => allStudents.add(grade.student));

  //  Converto para array para que eu possa ter as funcionalidades de um array
